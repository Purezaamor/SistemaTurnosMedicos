...
**Figura 0.** Aplicación del principio de herencia mediante las relaciones de generalización entre las clases `Persona`, `Paciente` y `Medico`, donde las clases derivadas heredan los atributos y comportamientos definidos en sus respectivas superclases.
