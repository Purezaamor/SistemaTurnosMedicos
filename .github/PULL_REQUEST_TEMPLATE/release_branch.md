...
|-----------------|-------------------------------|----------------|
| Ignacio Nervi   | Analista de Requerimientos    | @nachonervi-design |
| Kevin Ezequiel Sosa | Modelador de Casos de Uso | @keviineze     |
| lucas        | Diseñador de Clases Iniciales | @lucastol-dev    |
| Alejo Guerricabeitia | Documentador y Coordinador    | @Purezaamor   |
...
[Actividad Obligatoria N°1][GRUPO 3](https://github.com/Purezaamor/SistemaTurnosMedicos/pull/21)
